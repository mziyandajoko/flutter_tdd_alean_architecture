...
import 'package:flutter_tdd_alean_architecture/features/number_trivia/domain/usecases/get_concrete_number_trivia.dart';
...
void main() {
  ...
  test(
    ...
    () async {
      ...
      when(mockNumberTriviaRepository?.getConcreteNumberTrivia(42))
